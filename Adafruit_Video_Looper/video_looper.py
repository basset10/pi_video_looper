...
class VideoLooper:
    ...
    def _load_bgimage(self):
        ...
        if bgno == 13:
            image = pygame.image.load('/home/pi/loader13.png')
        if bgno == 14:
            image = pygame.image.load('/home/pi/loader14.png')
        if bgno == 15:
            image = pygame.image.load('/home/pi/loader15.png')
        if bgno == 16:
            image = pygame.image.load('/home/pi/loader16.png')
        if bgno == 17:
            image = pygame.image.load('/home/pi/loader17.png')
        if bgno == 18:
            image = pygame.image.load('/home/pi/loader18.png')
        if bgno == 19:
            image = pygame.image.load('/home/pi/loader19.png')
        if bgno == 20:
            image = pygame.image.load('/home/pi/loader20.png')
